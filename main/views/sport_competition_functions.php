...
<div id="competition_registration">
	<div id="reg_comment_p" style="width: 410px;">
		...
		<p>Если у вас есть какие-либо вопросы и пожелания, можете их указать в форме ниже.</p>
...
function sport_show_score_table(CupOneLap $cup, $full = true, $tableNumber = 1, $mobile = false, $maxLines = -1) {
	...
	$diff = $maxLines - count($resultTable);
	$marginBottom = ($maxLines > 0 && $diff > 0) ? sprintf("margin-bottom: %dpx", 34 * $diff) : "";
?>
